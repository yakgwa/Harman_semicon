...
#set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { b_sw[0]  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
#set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { b_sw[1]  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
#set_property -dict { PACKAGE_PIN W16  IOSTANDARD LVCMOS33 } [get_ports { b_sw[2]  }]; #IO_L20P_T3_A08_D24_14      ,Sch=SW2
#set_property -dict { PACKAGE_PIN W17  IOSTANDARD LVCMOS33 } [get_ports { b_sw[3]  }]; #IO_L20N_T3_A07_D23_14      ,Sch=SW3
#set_property -dict { PACKAGE_PIN W15  IOSTANDARD LVCMOS33 } [get_ports { g_sw[0]  }]; #IO_L21N_T3_DQS_A06_D22_14  ,Sch=SW4
#set_property -dict { PACKAGE_PIN V15  IOSTANDARD LVCMOS33 } [get_ports { g_sw[1]  }]; #IO_L21P_T3_DQS_14          ,Sch=SW5
#set_property -dict { PACKAGE_PIN W14  IOSTANDARD LVCMOS33 } [get_ports { g_sw[2]  }]; #IO_L22N_T3_A04_D20_14      ,Sch=SW6
#set_property -dict { PACKAGE_PIN W13  IOSTANDARD LVCMOS33 } [get_ports { g_sw[3]  }]; #IO_L22P_T3_A05_D21_14      ,Sch=SW7
#set_property -dict { PACKAGE_PIN V2   IOSTANDARD LVCMOS33 } [get_ports { r_sw[0]  }]; #IO_L5P_T0_34               ,Sch=SW8
#set_property -dict { PACKAGE_PIN T3   IOSTANDARD LVCMOS33 } [get_ports { r_sw[1]  }]; #IO_L2N_T0_34               ,Sch=SW9
#set_property -dict { PACKAGE_PIN T2   IOSTANDARD LVCMOS33 } [get_ports { r_sw[2] }]; #IO_L1N_T0_34               ,Sch=SW10
#set_property -dict { PACKAGE_PIN R3   IOSTANDARD LVCMOS33 } [get_ports { r_sw[3] }]; #IO_L2P_T0_34               ,Sch=SW11
...
# set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports { scale_sel }]; #IO_L3P_T0_DQS_34           ,Sch=SW14
set_property -dict { PACKAGE_PIN R2   IOSTANDARD LVCMOS33 } [get_ports { freeze_sw }]; #IO_L1P_T0_34               ,Sch=SW15
...
set_property -dict { PACKAGE_PIN L1   IOSTANDARD LVCMOS33 } [get_ports { LED }]; #IO_L6N_T0_VREF_35            ,Sch=LED15
...
set_property -dict { PACKAGE_PIN T17  IOSTANDARD LVCMOS33 } [get_ports { save_btn }]; #IO_L17P_T2_A14_D30_14 ,Sch=BTNR
...
set_property -dict { PACKAGE_PIN A16  IOSTANDARD LVCMOS33 } [get_ports { vsync }]; #IO_L12P_T1_MRCC_16 ,Sch=JB2
# set_property -dict { PACKAGE_PIN B15  IOSTANDARD LVCMOS33 } [get_ports { pclk }]; #IO_L11N_T1_SRCC_16 ,Sch=JB3
set_property -dict { PACKAGE_PIN A15  IOSTANDARD LVCMOS33 PULLUP true } [get_ports { sda }]; #IO_L6N_T0_VREF_16  ,Sch=JB7
set_property -dict { PACKAGE_PIN A17  IOSTANDARD LVCMOS33 } [get_ports { href }]; #IO_L12N_T1_MRCC_16 ,Sch=JB8
set_property -dict { PACKAGE_PIN C15  IOSTANDARD LVCMOS33 } [get_ports { xclk }]; #IO_L11P_T1_SRCC_16 ,Sch=JB9
set_property -dict { PACKAGE_PIN C16  IOSTANDARD LVCMOS33 } [get_ports { pclk }]; #IO_L13P_T2_MRCC_16 ,Sch=JB10


##Pmod Header JC

set_property -dict { PACKAGE_PIN K17  IOSTANDARD LVCMOS33 } [get_ports { data[7] }]; #IO_L12N_T1_MRCC_14 ,Sch=JC1
set_property -dict { PACKAGE_PIN M18  IOSTANDARD LVCMOS33 } [get_ports { data[5] }]; #IO_L11P_T1_SRCC_14 ,Sch=JC2
set_property -dict { PACKAGE_PIN N17  IOSTANDARD LVCMOS33 } [get_ports { data[3] }]; #IO_L13P_T2_MRCC_14 ,Sch=JC3
set_property -dict { PACKAGE_PIN P18  IOSTANDARD LVCMOS33 } [get_ports { data[1] }]; #IO_L14P_T2_SRCC_14 ,Sch=JC4
set_property -dict { PACKAGE_PIN L17  IOSTANDARD LVCMOS33 } [get_ports { data[6] }]; #IO_L12P_T1_MRCC_14 ,Sch=JC7
set_property -dict { PACKAGE_PIN M19  IOSTANDARD LVCMOS33 } [get_ports { data[4] }]; #IO_L11N_T1_SRCC_14 ,Sch=JC8
set_property -dict { PACKAGE_PIN P17  IOSTANDARD LVCMOS33 } [get_ports { data[2] }]; #IO_L13N_T2_MRCC_14 ,Sch=JC9
set_property -dict { PACKAGE_PIN R18  IOSTANDARD LVCMOS33 } [get_ports { data[0] }]; #IO_L14N_T2_SRCC_14 ,Sch=JC10
...
set_property -dict { PACKAGE_PIN N18  IOSTANDARD LVCMOS33 } [get_ports { b_port[0] }]; #IO_L9P_T1_DQS_14      ,Sch=VGA_B0
set_property -dict { PACKAGE_PIN L18  IOSTANDARD LVCMOS33 } [get_ports { b_port[1] }]; #IO_L8P_T1_D11_14      ,Sch=VGA_B1
set_property -dict { PACKAGE_PIN K18  IOSTANDARD LVCMOS33 } [get_ports { b_port[2] }]; #IO_L8N_T1_D12_14      ,Sch=VGA_B2
set_property -dict { PACKAGE_PIN J18  IOSTANDARD LVCMOS33 } [get_ports { b_port[3] }]; #IO_L7N_T1_D10_14      ,Sch=VGA_B3
set_property -dict { PACKAGE_PIN J17  IOSTANDARD LVCMOS33 } [get_ports { g_port[0] }]; #IO_L7P_T1_D09_14      ,Sch=VGA_G0
set_property -dict { PACKAGE_PIN H17  IOSTANDARD LVCMOS33 } [get_ports { g_port[1] }]; #IO_L5P_T0_D06_14      ,Sch=VGA_G1
set_property -dict { PACKAGE_PIN G17  IOSTANDARD LVCMOS33 } [get_ports { g_port[2] }]; #IO_L5N_T0_D07_14      ,Sch=VGA_G2
set_property -dict { PACKAGE_PIN D17  IOSTANDARD LVCMOS33 } [get_ports { g_port[3] }]; #IO_0_14               ,Sch=VGA_G3
set_property -dict { PACKAGE_PIN G19  IOSTANDARD LVCMOS33 } [get_ports { r_port[0] }]; #IO_L4N_T0_D05_14      ,Sch=VGA_R0
set_property -dict { PACKAGE_PIN H19  IOSTANDARD LVCMOS33 } [get_ports { r_port[1] }]; #IO_L4P_T0_D04_14      ,Sch=VGA_R1
set_property -dict { PACKAGE_PIN J19  IOSTANDARD LVCMOS33 } [get_ports { r_port[2] }]; #IO_L6N_T0_D08_VREF_14 ,Sch=VGA_R2
set_property -dict { PACKAGE_PIN N19  IOSTANDARD LVCMOS33 } [get_ports { r_port[3] }]; #IO_L9N_T1_DQS_D13_14  ,Sch=VGA_R3
