...
HD_PWD='C:/Users/kccistc/Desktop/Seanson_2/20251120_VGA_IMG_ROM_Grayfilter/251120_VGA_IMG_ROM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_RGB_Controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_RGB_Controller.tcl -notrace
