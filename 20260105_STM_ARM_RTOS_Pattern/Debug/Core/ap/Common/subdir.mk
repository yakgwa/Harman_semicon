...
C_SRCS += \
../Core/ap/Common/Common.c 

OBJS += \
./Core/ap/Common/Common.o 

C_DEPS += \
./Core/ap/Common/Common.d 


# Each subdirectory must supply rules for building sources it contributes
Core/ap/Common/%.o Core/ap/Common/%.su Core/ap/Common/%.cyclo: ../Core/ap/Common/%.c Core/ap/Common/subdir.mk
...
clean: clean-Core-2f-ap-2f-Common

clean-Core-2f-ap-2f-Common:
	-$(RM) ./Core/ap/Common/Common.cyclo ./Core/ap/Common/Common.d ./Core/ap/Common/Common.o ./Core/ap/Common/Common.su

.PHONY: clean-Core-2f-ap-2f-Common
