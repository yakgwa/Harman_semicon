...
module FND_controller (
    ...
    always_comb begin
        case (seg_sel)
            2'b00: FND_comm = FCR ? 4'b1110 : 4'b1111; // Digit 0 Ȱ��ȭ
            2'b01: FND_comm = FCR ? 4'b1101 : 4'b1111; // Digit 1 Ȱ��ȭ
            2'b10: FND_comm = FCR ? 4'b1011 : 4'b1111; // Digit 2 Ȱ��ȭ
            2'b11: FND_comm = FCR ? 4'b0111 : 4'b1111; // Digit 3 Ȱ��ȭ
            default: FND_comm = 4'b1111; // ��� �ڸ� ��Ȱ��ȭ
        endcase
    end
...
// 7-Segment ������ ���� ī���� (modified for 4 segments)
module counter #(
